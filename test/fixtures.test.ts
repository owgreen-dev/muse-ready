...
describe("bad fixtures", () => {
  ...
  it("every built-in rule has at least one seeded failure", async () => {
    ...
    const elsewhere = new Set(["META002", "NET002", "LAT001", "ERR002", "PAGE002", "MCP002", "META003", "AUTH003", "MCP003", "MCP004", "MCP005"]); // AUTH003: oauth.test.ts; MCP003: profiles.test.ts; MCP004/5: mcp-probe.test.ts // MCP002: profiles.test.ts; META003: listing.test.ts
